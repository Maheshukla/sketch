...
import { PageHeader, ProductCard } from "@/components/cards";
...
export default function Discover() {
  ...
  useEffect(() => {
    ...
    api.get("/products/recommended").then((r) => setRecommended(r.data)).catch(() => {});
  }, []);
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-8 py-12" data-testid="discover-page">
      ...
      {recommended.length > 0 && !cat && (
        <section className="mt-12" data-testid="recommended-section">
          <p className="font-meta text-[11px] text-muted-foreground mb-5">Recommended for you</p>
